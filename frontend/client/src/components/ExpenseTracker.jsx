...
import { LayoutDashboardIcon, PieChartIcon } from './Icons';
...
const ExpenseTracker = ({ setCurrentPage }) => {
      ...
      <div className="w-full max-w-4xl bg-white rounded-3xl shadow-2xl p-6 sm:p-10 transition-all duration-300">
        <header className="mb-8 flex justify-between items-center">
          ...
          <button
            ...
            className="p-2 bg-gray-100 rounded-full text-gray-600 hover:bg-gray-200 transition duration-150 text-sm font-medium flex items-center shadow-sm"
          >
                  ...
                  <div key={item.category}>
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <span className="text-sm font-bold">
                        {formatCurrency(item.amount)} ({item.percentage.toFixed(2)}%)
                      </span>
                    </div>
        ...
        <form onSubmit={addTransaction} className="grid grid-cols-1 sm:grid-cols-6 gap-3 mb-10 p-5 border border-gray-200 rounded-xl bg-white shadow-sm">
          ...
          <button
            ...
            className={`sm:col-span-1 flex items-center justify-center p-3 rounded-xl transition duration-150 shadow-md font-semibold ${isIncome ? 'bg-green-300 hover:bg-green-200 text-green-600' : 'bg-red-300 hover:bg-red-200 text-red-600'
              }`}
          >
